...
For Fluent SDK UI Action metadata, use `now-sdk explain uiaction-api --format raw` and route implementation to NowDev-AI-Fluent-UI-Developer. This UI Forms skill keeps `g_form` examples only.
