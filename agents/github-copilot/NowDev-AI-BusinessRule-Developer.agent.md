...
<workflow>
1. API verification: If Context7 is available, query-docs to verify Business Rule best practices, trigger conditions, API patterns. If unavailable, use built-in best practices knowledge.
