---
# nowdev-managed: true
# nowdev-hash: 2894140949ea8fa9b6b188bedaa9a40bc189173d0e205229e45dd2533cf64463
...
For any artifact type under review, load `nowdev-ai-toolbox-servicenow-sdk`, discover the relevant topic, and retrieve its current API definition. The skill is the sole authority for `now-sdk` CLI mechanics.
  ...
  - https://servicenow.github.io/sdk/llms.txt — prefer this for current, authoritative content; fall back to the servicenow-fluent-development skill only if unavailable (bundled docs may not reflect the latest SDK or platform changes) only for supplementary review context not covered by the installed SDK topic
