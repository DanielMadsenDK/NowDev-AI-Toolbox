# AI Directive: ServiceNow General Scripting Best Practices

## Context
Universal coding standards for all ServiceNow server-side JavaScript (Script Includes, Business Rules, Fix Scripts).
...
## 2. Database Interactions (GlideRecord)
*   **Counting:**
